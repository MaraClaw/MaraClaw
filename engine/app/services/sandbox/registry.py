...
class SandboxBackendFactory(Protocol):
    """Construct a sandbox backend from its shared configuration."""

    def __call__(self, config: SandboxConfig) -> SandboxBackend:
        """Create a configured sandbox backend."""
        ...
...
def register_sandbox_backend(sandbox_type: SandboxType, backend_class: SandboxBackendFactory) -> None:
    """
