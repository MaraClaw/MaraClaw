...
type EmailTemplates = dict[str, EmailTemplate]
...
DEFAULT_EMAIL_TEMPLATES: EmailTemplates = {
    "email_verification": {
...
async def get_email_templates() -> EmailTemplates:
...
async def _load_templates_from_db(templates: EmailTemplates) -> EmailTemplates:
