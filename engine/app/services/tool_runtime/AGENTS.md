...
Execution belongs in `agent_tool_exec/` (`@register`). Seed tables belong in `tool_definitions/`. OpenAI catalog slices come from `agent_tools_definitions/`. Do not add handlers here.
