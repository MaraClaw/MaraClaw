...
DEFAULT_TEMPLATES: list[TemplateSeed] = [
    {
...
def _merged_templates() -> list[TemplateSeed]:
    """Python legacy + folder templates, folder wins on name collision."""
    by_name: dict[str, TemplateSeed] = {template["name"]: template for template in DEFAULT_TEMPLATES}
